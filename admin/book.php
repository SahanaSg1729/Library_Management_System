...
<?php
  ...
  {
      $where='WHERE SECTION_NO = '.$catid.' AND BRANCH_ID ='.$branchid; 
  }
  elseif(isset($_GET['category'])){
    $catid = $_GET['category'];
    $where = 'WHERE SECTION_NO = '.$catid;
  }
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right" style="right:158px;">
                <form class="form-inline">
                  <div class="form-group">
                    <label>Branch: </label>
...
$(function(){
  ...
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_edition').val(response.category_id).html(response.name);
